...
public class Game {
    ...
    public void initialize() {
        ...
        try {
            ...
            // load our sound data
            SOUND_SHOT   = soundManager.addSound("shoot.wav");
        ...
        // get our sprites
        gotYou = getSprite("alien.gif");
        pressAnyKey = getSprite("bullet.gif");
        youWin = getSprite("ship.gif");
        ...
        for (int i = 0; i < shots.length; i++) {
            shots[i] = new ShotEntity(this, "bullet.gif", 0, 0);
        }
